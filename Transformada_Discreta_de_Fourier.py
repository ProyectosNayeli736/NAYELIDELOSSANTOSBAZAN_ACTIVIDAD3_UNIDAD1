...
import numpy as np
import scipy.fftpack as fourier #para calcular la transformada
import matplotlib.pyplot as plt #para realizar las graficas
...
La nota es RE, con frecuencia:  [145.9878178]
...
!pip install PyAudio
Requirement already satisfied: PyAudio in c:\users\usuario\miniconda3\envs\mientorno\lib\site-packages (0.2.11)
import matplotlib
